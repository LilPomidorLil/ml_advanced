...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\subcaptionbox{Subcaption A}{\includegraphics[width=0.45\textwidth]{fig_1}}%
		\hfill % <-- Seperation
		\subcaptionbox{Subcaption B}{\includegraphics[width=0.45\textwidth]{fig_1}}%
		\\ % <-- Line break
		\subcaptionbox{Subcaption C}{\includegraphics[width=0.45\textwidth]{fig_1}}%
		\hfill % <-- Seperation
		\subcaptionbox{Subcaption D}{\includegraphics[width=0.45\textwidth]{fig_1}}%
		\caption{Caption}
	\end{figure}
